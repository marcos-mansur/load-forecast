...
TRAIN_PREDICTION_PATH: Path = PREDICTION_DATA_PATH / "train.csv"
VAL_PREDICTION_PATH: Path = PREDICTION_DATA_PATH / "val.csv"
TEST_PREDICTION_PATH: Path = PREDICTION_DATA_PATH / "test.csv"
