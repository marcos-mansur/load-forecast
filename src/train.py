...
#mlflow.tensorflow.
mlflow.tensorflow.autolog(registered_model_name="autoregressive")
...
with mlflow.start_run():
    ...
    lc_fig = learning_curves(
                history=history, 
                skip=20
                )
    lc_fig.savefig(os.path.join(VALUATION_PATH, 
                            "learning_curves.png"))
    ...
    pred_series_fig.savefig(os.path.join(VALUATION_PATH,
                                "prediction_series.png"))
    ...
    metricas_fig.savefig(os.path.join(VALUATION_PATH,
                                    "metrics_semana.png"))
